...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES=(
        ...
        "https://github.com/IceWhaleTech/CasaOS-LocalStorage/releases/download/v0.3.7-alpha5/linux-${TARGET_ARCH}-casaos-local-storage-v0.3.7-alpha5.tar.gz"
        "https://github.com/IceWhaleTech/CasaOS/releases/download/v0.3.7-alpha4/linux-${TARGET_ARCH}-casaos-v0.3.7-alpha4.tar.gz"
